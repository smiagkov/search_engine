...
@Repository
public interface PageRepository extends ListCrudRepository<PageEntity, Integer>, PageRepositoryCustomized {
    ...
    Optional<PageEntity> findByPathSite(String path, SiteEntity site);
